...
class DetailPKBMekanik extends StatefulWidget {
  const DetailPKBMekanik({super.key});

  @override
  State<DetailPKBMekanik> createState() => _DetailPKBState();
}

class _DetailPKBState extends State<DetailPKBMekanik> {
          ...
          children: [
            Container(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Get.toNamed(Routes.STARTSTOPPKBMEKANIK, arguments: {
                    'kode_svc': args['kode_svc'] ?? '',
                    'kode_booking': args['kode_booking'] ??
                        '', // Assuming selectedItemJasa contains the selected kode_jasa
                  });
                },
