...
import '../modules/promek/detail/detailpkbmekanik.dart';
import '../modules/promek/detail/detailpkbview.dart';
import '../modules/promek/start_stop/start_stop_view.dart';
import '../modules/promek/start_stop/start_stop_view_mekanik.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      transition: Transition.downToUp,
      name: _Paths.DETAILPKBMEKANIK,
      page: () => const DetailPKBMekanik(),
      binding: DetailHistoryBinding(),
    ),
    GetPage(
      transition: Transition.downToUp,
    ...
    GetPage(
      transition: Transition.downToUp,
      name: _Paths.STARTSTOPPKBMEKANIK,
      page: () => const StartStopViewMekanik(),
      binding: DetailHistoryBinding(),
    ),
    GetPage(
      transition: Transition.downToUp,
